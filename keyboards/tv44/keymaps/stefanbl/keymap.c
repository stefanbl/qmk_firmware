...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   SPCWINP, KC_SPC,                    NO_ALGR, MO(_L2), MO(_L5) 
  ),
  ...
  [_L2] = LAYOUT( /* Fn layer */
    ...
    _______, _______, _______, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_INS,  KC_ENT,
  ...
  [_WINPRG] = LAYOUT( /* Programming Win */
    KC_ESC,      NO_APOS, NO_QUO2, _______, _______, KC_F5,   NO_SLSH,    _______, NO_PIPE, _______, NO_PLUS, NO_AA,
    MO(_PRGEXT), _______, _______, _______, KC_F10,  KC_F11,  NO_LCBR,    NO_LPRN, NO_RPRN, NO_RCBR, NO_APOS, NO_AE,
  ...
  [_MACPRG] = LAYOUT( /* Programming Mac */
    KC_ESC,      NO_APOS, NO_QUO2, _______, _______, KC_F5,   NO_SLSH,     _______, NO_PIPE_MAC, _______,     NO_PLUS, NO_AA,
  ...
  [_PRGEXT] = LAYOUT( /* Programming extended */
    _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, NO_QUES, _______,
